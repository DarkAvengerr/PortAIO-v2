 ...
 namespace SSHCommon
{
    ...
    public class Evader
    {
        ...
        public Evader(out Menu _evade, EvadeMethods method = EvadeMethods.None, Spell spl = null)
        {
            ...
            Chat.Print("<font color='#ff3232'>HikiCarry Ekko: </font><font color='#d4d4d4'>Evader loaded! You can rekt everyone with this assembly!</font>");
        }
        ...
        {
            if (evade != null && evade.Item("EVADEENABLE").GetValue<bool>() && sender.Type == GameObjectType.AIHeroClient && sender.IsEnemy)
            {
