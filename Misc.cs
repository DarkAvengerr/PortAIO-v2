        ...
        public static void Load()
        {
            ...
            switch (ObjectManager.Player.Hero)
            {
                ...
                case EloBuddy.Champion.Rengar:
                    champ = new string[] { "ElRengar : Revamped", "D-Rengar", "SAutoCarry", "[SDK] Pridestalker Rengar" };
                    break;
                ...
                case EloBuddy.Champion.Thresh:
                    champ = new string[] { "Danz - Chain Warden", "FreshBooster", "OKTW", "Support is Easy", "vSeries", "Dark Star Thresh" };
                    break;
