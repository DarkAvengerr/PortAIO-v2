...
namespace Nautilus_AnchorTheChallenger
{
    ...
    class program
    {
        ...
        //    private static void Interrupter2_OnInterruptableTarget(AIHeroClient unit, InterruptableSpell spell)

        private static void Interrupter2_OnInterruptableTarget(AIHeroClient unit, Interrupter2.InterruptableTargetEventArgs spell)
        {
