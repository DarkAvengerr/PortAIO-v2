...
namespace FioraProject
{
    class HINH1
    {
        ...
        private static void DrawHinh1(Vector3 center, float radius, Color color, int width = 5)
        {
            ...
            var pos1 = pos1y.LSTo2D().RotateAround(center.LSTo2D(), drawstate.AngleToRadian());
            var pos1a = center.LSExtend(pos1.To3D(), radius * 5 / 8).LSTo2D().RotateAround(center.LSTo2D(), (18).AngleToRadian());
            var pos2 = pos1.RotateAround(center.LSTo2D(), (36).AngleToRadian());
            var pos3 = pos1.RotateAround(center.LSTo2D(), (72).AngleToRadian());
            var pos4 = pos1.RotateAround(center.LSTo2D(), (108).AngleToRadian());
            var pos5 = pos1.RotateAround(center.LSTo2D(), (144).AngleToRadian());
            var pos6 = pos1.RotateAround(center.LSTo2D(), (180).AngleToRadian());
            var pos7 = pos1.RotateAround(center.LSTo2D(), (216).AngleToRadian());
            var pos8 = pos1.RotateAround(center.LSTo2D(), (252).AngleToRadian());
            var pos9 = pos1.RotateAround(center.LSTo2D(), (288).AngleToRadian());
            var pos10 = pos1.RotateAround(center.LSTo2D(), (324).AngleToRadian());
            var pos2a = pos1a.RotateAround(center.LSTo2D(), (36).AngleToRadian());
            var pos3a = pos1a.RotateAround(center.LSTo2D(), (72).AngleToRadian());
            var pos4a = pos1a.RotateAround(center.LSTo2D(), (108).AngleToRadian());
            var pos5a = pos1a.RotateAround(center.LSTo2D(), (144).AngleToRadian());
            var pos6a = pos1a.RotateAround(center.LSTo2D(), (180).AngleToRadian());
            var pos7a = pos1a.RotateAround(center.LSTo2D(), (216).AngleToRadian());
            var pos8a = pos1a.RotateAround(center.LSTo2D(), (252).AngleToRadian());
            var pos9a = pos1a.RotateAround(center.LSTo2D(), (288).AngleToRadian());
            var pos10a = pos1a.RotateAround(center.LSTo2D(), (324).AngleToRadian());
