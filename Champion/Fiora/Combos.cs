...
namespace FioraProject
{
    ...
    public static class Combos
    {
        ...
        {
            if (EloBuddy.SDK.Item.CanUseItem(ItemId.Tiamat_Melee_Only) || EloBuddy.SDK.Item.CanUseItem(ItemId.Ravenous_Hydra_Melee_Only)
                || EloBuddy.SDK.Item.CanUseItem(3748))
            {
                return true;
            }
            else
        ...
        public static void CastItem()
        {
            ...
            if (EloBuddy.SDK.Item.CanUseItem(ItemId.Tiamat_Melee_Only))
                EloBuddy.SDK.Item.UseItem(ItemId.Tiamat_Melee_Only);
            if (EloBuddy.SDK.Item.CanUseItem(ItemId.Ravenous_Hydra_Melee_Only))
                EloBuddy.SDK.Item.UseItem(ItemId.Ravenous_Hydra_Melee_Only);
            // titanic hydra
