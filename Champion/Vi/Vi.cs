using EloBuddy; namespace ElVi
{
    ...
    internal static class Vi
    {
        ...
        public static float GetComboDamage(Obj_AI_Base enemy)
        {
            ...
            if (Spells[ElVi.Spells.Q].LSIsReady())
            {
                damage += Player.LSGetSpellDamage(enemy, SpellSlot.Q);
            }
            if (Spells[ElVi.Spells.E].LSIsReady())
            {
                damage += Player.LSGetSpellDamage(enemy, SpellSlot.E) * Spells[ElVi.Spells.E].Instance.Ammo
                          + (float)Player.LSGetAutoAttackDamage(enemy);
            }

            if (Spells[ElVi.Spells.R].LSIsReady())
            {
        ...
        private static void AntiGapcloser_OnEnemyGapcloser(ActiveGapcloser gapcloser)
        {
            ...
            {
                if (Spells[ElVi.Spells.Q].LSIsReady() && gapcloser.Sender.LSDistance(Player) < Spells[ElVi.Spells.Q].Range)
                {
        ...
        private static void OnCombo()
        {
            ...
            if (ElViMenu._menu.Item("ElVi.Combo.Q").GetValue<bool>() && Spells[ElVi.Spells.Q].LSIsReady())
            {
                if (Spells[ElVi.Spells.Q].IsCharging)
                {
            ...
            if (ElViMenu._menu.Item("ElVi.Combo.R").GetValue<bool>() && Spells[ElVi.Spells.R].LSIsReady()
        ...
        private static void OnHarass()
        {
            ...
            if (ElViMenu._menu.Item("ElVi.Harass.Q").GetValue<bool>() && Spells[ElVi.Spells.Q].LSIsReady())
            {
                if (Spells[ElVi.Spells.Q].IsCharging)
                {
            ...
            if (ElViMenu._menu.Item("ElVi.Harass.E").GetValue<bool>() && Spells[ElVi.Spells.E].LSIsReady())
            {
        ...
        private static void OnJungleClear()
        {
            ...
            if (useQ && Spells[ElVi.Spells.Q].LSIsReady())
            {
                if (!Spells[ElVi.Spells.Q].IsCharging)
                {
                    Spells[ElVi.Spells.Q].StartCharging();
            ...
            if (useE && Spells[ElVi.Spells.E].LSIsReady())
            {
                ...
                if (minions.Count == minions.Count(x => Player.LSDistance(x) < Spells[ElVi.Spells.E].Range)
                    && bestFarmPos.Position.LSIsValid() && bestFarmPos.MinionsHit > 1)
                {
                    Spells[ElVi.Spells.E].Cast();
                }
            }
        ...
        private static void OnLaneClear()
        {
            ...
            if (useQ && Spells[ElVi.Spells.Q].LSIsReady())
            {
                ...
                else
                {
                    ...
                    if (minions.Count == minions.Count(x => Player.LSDistance(x) < Spells[ElVi.Spells.Q].Range)
                        && bestFarmPos.Position.LSIsValid() && bestFarmPos.MinionsHit > 2)
                    {
