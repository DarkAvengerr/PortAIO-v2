...
using EloBuddy; namespace XinZhao
{
    ...
    internal class AssassinManager
    {
        ...
        public AIHeroClient GetTarget( float vDefaultRange = 0, TargetSelector.DamageType vDefaultDamageType = TargetSelector.DamageType.Physical)
        {
            if (this.Selector != TargetSelect.XinZhao)
            {
