                 ...
                 Config.Item("ManaSliderHarass").GetValue<Slider>().Value))
            {
                ...
                if (target != null)
                {
                    ...
                    if (((comboActive && Config.Item("UseQCombo").GetValue<bool>()) ||
                         (harassActive && Config.Item("UseQHarass").GetValue<bool>())) && Q1.LSIsReady())
                    {
                        CastQ(target);
                    }

                    if (((comboActive && Config.Item("UseWCombo").GetValue<bool>()) ||
                         (harassActive && Config.Item("UseWHarass").GetValue<bool>())) && W.LSIsReady())
                    {
                    ...
                    if (((comboActive && Config.Item("UseECombo").GetValue<bool>()) ||
                         (harassActive && Config.Item("UseEHarass").GetValue<bool>())) && E.LSIsReady())
                    {
                    ...
                    //R at close range
                    if (comboActive && useR && R.LSIsReady() &&
                        (ObjectManager.Player.LSGetSpellDamage(target, SpellSlot.Q) +
