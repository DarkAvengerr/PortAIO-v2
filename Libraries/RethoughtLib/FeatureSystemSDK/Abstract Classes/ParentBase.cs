 ...
 namespace RethoughtLib.FeatureSystemSDK.Abstract_Classes
{
    ...
    public abstract class ParentBase : Base
    {
        ...
        protected virtual void OnChildRemove(object sender, ParentBaseEventArgs parentBaseEventArgs)
        {
            ...
            this.Menu.Remove(parentBaseEventArgs.Child.Menu);
        }
        ...
        {
            var menuItem = this.Menu[this.Name + "Enabled"];

            if (menuItem.GetValue<MenuBool>().Value)
            {
                menuItem.GetValue<MenuBool>().Value = false;
                return;
            }
        ...
        protected override void OnEnable(object sender, FeatureBaseEventArgs featureBaseEventArgs)
        {
            ...
            if (!menuItem.GetValue<MenuBool>().Value)
            {
                menuItem.GetValue<MenuBool>().Value = true;
                return;
            }
