...
namespace SephSyndra
{
    class Syndra : Helper
    {
        ...
        void Obj_AI_Base_OnPauseAnimation(Obj_AI_Base sender, EventArgs args)
        {
            ...
            if (SpellManager.E.IsReady() && SpellManager.Q.IsReady())
            {
                ...
                if (target != null)
                {
                    ...
                    if (pred.Hitchance >= HitChance.Medium)
                    {
                        ...
                        LeagueSharp.Common.Utility.DelayAction.Add(150, () => SpellManager.E.Cast(pos));
                    }
                }
            }
        }
        ...
        void CastRSpecific(AIHeroClient candidate)
        {
            var orbcount = GetOrbcount();
            if (candidate.HealthPercent < GetSliderFloat("c.rminh"))
            {
