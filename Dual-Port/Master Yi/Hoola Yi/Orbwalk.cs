 ...
 namespace HoolaMasterYi
{
    ...
    public static class Orbwalking
    {
        ...
        public static void Orbwalk(AttackableUnit target,
            ...
            bool randomizeMinDistance = true)
        {
            if (target.LSIsValidTarget() && CanAttack && Attack)// Fix this later - Berb
            {
                DisableNextAttack = false;
            ...
            if (CanMove(extraMoveup) && Move)// Fix this later - Berb
            {
        ...
        private static void SpellbookOnStopCast(Obj_AI_Base spellbook, SpellbookStopCastEventArgs args)// Fix this later - Berb
        {
        ...
        private static void OnProcessSpell(Obj_AI_Base unit, GameObjectProcessSpellCastEventArgs Spell)// Fix this later - Berb
        {
