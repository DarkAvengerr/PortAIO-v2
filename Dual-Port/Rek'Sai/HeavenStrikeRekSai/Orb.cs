    ...
    public static class Orbwalking
    {
        ...
        private static void Obj_AI_Base_OnSpellCast(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            ...
            try
            {
                ...
                {
                    _missileLaunched = true;
                    LeagueSharp.Common.Utility.DelayAction.Add(37 > Game.Ping ? 50 - Game.Ping : 0, () => StopMove = false);
                    if (args.Target is Obj_AI_Base)
                    {
                        //Trigger it for ranged until the missiles catch normal attacks again!
                        LeagueSharp.Common.Utility.DelayAction.Add(37 > Game.Ping ? 50 - Game.Ping : 0, () => FireAfterAttack(sender, _lastTarget));
                    }
                }
            }
            catch (Exception e)
