...
namespace UnderratedAIO.Champions
{
    internal class Hecarim
    {
        ...
        private void Harass()
        {
            AIHeroClient target = TargetSelector.GetTarget(1000, TargetSelector.DamageType.Magical, true);
        ...
        private void Combo()
        {
            ...
            if (config.Item("user", true).GetValue<bool>() && R.LSIsReady() && R.CanCast(target))
            {
