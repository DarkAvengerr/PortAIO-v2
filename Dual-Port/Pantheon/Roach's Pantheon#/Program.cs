 ...
 namespace RoachPantheon
{
    internal class Program
    {
        ...
        static void Game_OnGameLoad()
        {
            ...
            Chat.Print("<font color=\"#D2444A\">Pantheon# -</font> <font color=\"#FFFFFF\">Loaded</font>");
        }
        ...
        private static void Drawing_OnDraw(EventArgs args)
        {
            ...
            {
                LeagueSharp.Common.Utility.DrawCircle(Variable.Player.Position, spell.Range,
            ...
            {
                LeagueSharp.Common.Utility.DrawCircle(target.Position, 50, Variable.Config.Item("Target").GetValue<Circle>().Color, 1, 50);
            }
        ...
        private static void Interrupter_OnPossibleToInterrupt(AIHeroClient unit,
