                ...
                try
                {
                    using (var c = new WebClient())
                    {
                        ...
                        if (match.Success)
                        {
                            ...
                            {
                                Chat.Print("<font color='#15C3AC'>Support:</font> <font color='#FF0000'>" + "OUTDATED - Please Update to Version: " + gitVersion + "</font>");
                                Chat.Print("<font color='#15C3AC'>Support:</font> <font color='#FF0000'>" + "OUTDATED - Please Update to Version: " + gitVersion + "</font>");
                            }
                            else
                            {
                                Chat.Print("<font color='#15C3AC'>Slutty Lee Sin:</font> <font color='#40FF00'>" + "UPDATED - Version: " + gitVersion + "</font>");
                            }
                        }
                    }
                }
