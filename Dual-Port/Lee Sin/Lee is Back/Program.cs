...
namespace LeeSin
{
    class Program
    {
        ...
        private static void Drawing_RKickWaveForHitToEnemy(EventArgs args)
        {
            ...
            //List<AIHeroClient> xEnemy = new List<AIHeroClient>();
            //foreach (
        ...
        private static void Game_OnUpdate(EventArgs args)
        {
            ...
            //{
            //    Console.WriteLine(VARIABLE.BaseSkinName.ToString());
            //}
            ...
            //    {
            //        Chat.Print(enemy.ChampionName + " : Have ");
            //    }
            //    //return;
            ...
            //    //    {
            //    //        Chat.Print(enemy.ChampionName + " : " + buff.Name.ToLower());
            //    //    }
            //    //}
        ...
        private static void OnWndProc(WndEventArgs args)
        {
            if (args.Msg == 515 || args.Msg == 513)
            {
                ...
                var boohoo = ObjectManager.Get<Obj_AI_Base>()
                         ...
                         .FirstOrDefault(
                             obj =>
                                 obj.IsAlly && !obj.IsMe && !obj.IsMinion && (obj is Obj_AI_Turret || obj is AIHeroClient) &&
        ...
        private static void OnProcessSpell(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            ...
            if (sender.IsAlly || !sender.Type.Equals(GameObjectType.AIHeroClient) ||
                (((AIHeroClient)sender).ChampionName != "MonkeyKing" && ((AIHeroClient)sender).ChampionName != "Akali") ||
        ...
        private static void Flee()
        {
            ...
            if (ObjectManager.Player.Distance(Game.CursorPos) >= 700 || walljump)
            {
                ...
                EloBuddy.Player.IssueOrder(GameObjectOrder.MoveTo, movepoint);
            }
            else
                WardJump(jumppoint);
        }
        ...
        private static void Insec()
        {
            ...
            //    {
            //        R.CastOnUnit(t);
            //        LeagueSharp.Common.Utility.DelayAction.Add(Game.Ping + 125, () => ObjectManager.Player.Spellbook.CastSpell(flashSlot, InsecJumpPosition));
            //        canmove = 0;
            //    }
            //    else
            //        WardJump(InsecJumpPosition);
        ...
        {
            var enemyVisible =
                        ObjectManager.Get<AIHeroClient>().Where(enemy => enemy.IsValidTarget() && ObjectManager.Player.Distance(enemy.ServerPosition) <= 600).FirstOrDefault();
        ...
        private static void Drawing_OnDraw_Insec(EventArgs args)
        {
            ...
            //    obj =>
            //            obj.IsAlly && !obj.IsMe && !obj.IsDead && !obj.IsMinion && (obj is Obj_AI_Turret || obj is AIHeroClient) &&
        ...
        private static void Drawing_OnDraw(EventArgs args)
        {
            ...
            {
                foreach (var enemyVisible in ObjectManager.Get<AIHeroClient>().Where(enemyVisible => enemyVisible.IsValidTarget()))
