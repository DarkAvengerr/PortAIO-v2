 ...
 namespace LeeSin
{
    ...
    internal class AssassinManager
    {
        ...
        public static AIHeroClient GetTarget(float vDefaultRange = 0, TargetSelector.DamageType vDefaultDamageType = TargetSelector.DamageType.Physical, IEnumerable<AIHeroClient> ignoredChamps = null)
        {
            //if (Selector != TargetSelect.LeeSin)
            //{
        ...
        private AIHeroClient KillableEnemy
        {
            get
            {
                AIHeroClient t = GetTarget(Program.Q.Range);
