 ...
 namespace HeavenStrikeNidalee
{
    public static class Orbwalking
    {
        ...
        private static readonly string[] AttackResets =
        {
            ...
            "sivirw", "talonnoxiandiplomacy", "trundletrollsmash", "vaynetumble", "vie", "volibearq",
        ...
        public class Orbwalker
        {
            ...
            public virtual AttackableUnit GetTarget()
            {
                    ...
                    ActiveMode == OrbwalkingMode.LastHit)
                {
                    ...
                    {
                        var FreezeDamage = Player.LSGetAutoAttackDamage(minion, false) * (_config.Item("FreezeHealth").GetValue<Slider>().Value / 100f);
                        ...
                        if (minion.Team != GameObjectTeam.Neutral && MinionManager.IsMinion(minion, true))
                        {
                            ...
                            if (predHealth > 0 && predHealth <= (FreezeActive ? FreezeDamage : Player.LSGetAutoAttackDamage(minion, true)))
                            {
                                return minion;
                            }
                        }
