...
using EloBuddy; namespace SFXChallenger.Managers
{
    public class HeroListManager
    {
        ...
        public static List<AIHeroClient> GetEnabledHeroes(string uniqueId)
        {
            var heroes = new List<AIHeroClient>();
            try
            {
                Tuple<Menu, HeroListManagerArgs> tuple;
                if (Menues.TryGetValue(uniqueId, out tuple))
        ...
        public static bool Check(string uniqueId, AIHeroClient hero)
        {
