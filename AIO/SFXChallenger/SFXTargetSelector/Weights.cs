    ...
    public static partial class TargetSelector
    {
        public static partial class Weights
        {
            ...
            static Weights()
            {
                ...
                PItems.AddRange(
                    new List<Item>
                    {
                        ...
                        new Item(
                            "ability-power", "Ability Power", 15, false, delegate(AIHeroClient t)
                            {
                        ...
                        new Item(
                            "focus-me", "Focus Me", 0, false, delegate(AIHeroClient t)
                            {
            ...
            public class Heroes
            {
                ...
                public static int GetPercentage(AIHeroClient hero)
                {
                    if (hero != null)
                    {
                        if (Menu != null)
                ...
                public static void SetPercentage(AIHeroClient hero, int percentage)
                {
            ...
            public class Item
            {
                ...
                public Item(string uniqueName,
                    ...
                    int weight,
                    bool inverted,
                    Func<AIHeroClient, float> valueFunction,
                    string tooltip = null)
                {
                ...
                public Func<AIHeroClient, float> ValueFunction { get; set; }
