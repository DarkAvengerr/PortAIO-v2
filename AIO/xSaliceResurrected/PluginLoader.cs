            ...
            if (!_loaded)
            {
                switch (ObjectManager.Player.ChampionName.ToLower())
                {
                    case "ahri":
                        ...
                        break;
                    case "akali":
                        new xSaliceResurrected.Mid.Akali();
                        _loaded = true;
                        break;
                    case "anivia":
                        new Anivia();
                    ...
                    case "fiora":
                        ...
                        break;
                    case "irelia":
                        new xSaliceResurrected.Top.Irelia();
                        _loaded = true;
                        break;
                    case "jinx":
                        new Jinx();
                    ...
                    case "jayce":
                        ...
                        break;
                    case "orianna":
                        new xSaliceResurrected.Mid.Orianna();
                        _loaded = true;
                        break;
                    case "rumble":
                        new Rumble();
                        ...
                        break;
                    case "syndra":
                        new xSaliceResurrected.Mid.Syndra();
                        _loaded = true;
                        break;
                    case "vayne":
                        new Vayne();
                        ...
                        break;
                    case "viktor":
                        new xSaliceResurrected.Mid.Viktor();
                        _loaded = true;
                        break;
                    case "vladimir":
                        new Vladimir();
                    ...
                    case "anivia":
                        new Anivia();
                        loaded = true;
                        Chat.Print("<font color = \"#FFB6C1\">xSalice's " + ObjectManager.Player.ChampionName + " Loaded!</font>");
                        break;
                    case "annie":
                        new Annie();
                        loaded = true;
