 ...
 namespace iSeriesReborn.Utility.Geometry
{
    ...
    public static class iSRGeometry
    {
        ...
        public static List<Vector2> GetEnemyPoints(bool dynamic = true)
        {
            ...
            var polygonsList = PositioningVariables.EnemiesClose.Select(enemy => new iSRGeometry.Circle(enemy.ServerPosition.LSTo2D(), (dynamic ? (enemy.IsMelee ? enemy.AttackRange * 1.5f : enemy.AttackRange) : staticRange) + enemy.BoundingRadius + 20).ToPolygon()).ToList();
