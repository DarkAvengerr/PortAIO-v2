...
namespace SFXTargetSelector
{
    public static partial class TargetSelector
    {
        public static partial class Priorities
        {
            ...
            public static Priority GetDefaultPriority(AIHeroClient hero)
            {
            ...
            public static int GetPriority(AIHeroClient hero)
            {
                if (hero != null)
                {
                    if (Menu != null)
            ...
            public static void SetPriority(AIHeroClient hero, int value)
            {
            ...
            public static void SetPriority(AIHeroClient hero, Priority type)
            {
