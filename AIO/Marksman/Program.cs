 ...
 namespace Marksman
{
    ...
    internal class Program
    {
        ...
        public static Marksman.Champions.Champion CClass;

        public static Marksman.Utils.Activator AActivator;
        ...
        public static void Game_OnGameLoad()
        {
            ...
            CClass = new Marksman.Champions.Champion();
            ...
            switch (championName)
            {
                ...
                case "graves":
                    ...
                    break;
                case "gnar":
                    CClass = new Marksman.Champions.Gnar();
                    break;
                case "jinx":
                    CClass = new Jinx();
                    break;
            ...
            AActivator = new Marksman.Utils.Activator();
        ...
        private static void LoadDefaultCompareChampion()
        {
            ...
            List<AIHeroClient> mobs = HeroManager.Enemies;

            AIHeroClient compChampion =
        ...
        private static void Drawing_OnDraw(EventArgs args)
        {
            ...
            if (Config.Item("Marksman.Compare.Set").GetValue<StringList>().SelectedIndex == 1 && ObjectManager.Player.Level < 6)
            {
                ...
                {
                    AIHeroClient compChampion = null;
                    foreach (
                        AIHeroClient e in
        ...
        public static void UseSummoners()
        {
            ...
            if (Config.Item("SUMIGNITEENABLE").GetValue<bool>())
            {
                ...
                var t = CClass.Orbwalker.GetTarget() as AIHeroClient;
        ...
        {
            CClass.Obj_AI_Base_OnBuffLose(sender, args);
        }
