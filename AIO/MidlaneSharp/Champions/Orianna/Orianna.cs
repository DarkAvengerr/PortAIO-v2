 ...
 namespace MidlaneSharp
{
    public partial class Orianna : BaseChamp
    {
        ...
        private void Ball_OnProcessCommand(Orianna.BallMgr.Command cmd, AIHeroClient target)
        {
        ...
        private int CountEnemiesInRangePredicted(float range, float width, float time, AIHeroClient t = null)
        {
            int cnt = 0;
