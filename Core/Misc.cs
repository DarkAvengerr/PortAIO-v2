        ...
        public static void Load()
        {
            ...
            switch (ObjectManager.Player.Hero)
            {
                ...
                case EloBuddy.Champion.Syndra:
                    champ = new string[] { "Syndra by Kortatu", "BadaoSeries", "Hikigaya Syndra", "OKTW", "Syndra by L33T", "vSeries", "xSalice", "SephSyndra", "Syndra - The Dark Sovereign", "Syndra - Dark Mage", "Lord's Syndra" };
                    break;
                ...
                case EloBuddy.Champion.Yasuo:
                    champ = new string[] { "YasuoPro", "BrianSharp", "GosuMechanics", "YasuoSharpv2", "[Yasuo] Master of Wind", "M1D 0R F33D", "YasuoMemeBender", "Media's Yasuo", "[SDK] Valvrave#", "BadaoYasuo", "hYasuo", "ReformedAIO", "Flowers' Yasuo" };
                    break;
