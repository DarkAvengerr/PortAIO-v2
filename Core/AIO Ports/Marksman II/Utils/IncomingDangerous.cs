    ...
    internal class IncomingDangerous
    {
        ...
        private static void Drawing_OnDraw(EventArgs args)
        {
            if (incDangerous)
            {
                ...
                {
                    Utils.DrawText(Common.CommonGeometry.TextWarning, text, Drawing.Width*0.22f, Drawing.Height*0.44f, SharpDX.Color.White);
                    Utils.DrawText(Common.CommonGeometry.Text, "You can Turn Off this message! Go to 'Marksman -> Activator -> Incoming Dangerous'", Drawing.Width*0.325f, Drawing.Height*0.52f, SharpDX.Color.White);
                }
            }
