...
using EloBuddy; namespace SFXChallenger.Abstracts
{
    // ReSharper disable once InconsistentNaming
    internal abstract class TChampion : Abstracts.Champion
    {
        public readonly float MaxRange;
        public List<AIHeroClient> Targets = new List<AIHeroClient>();
