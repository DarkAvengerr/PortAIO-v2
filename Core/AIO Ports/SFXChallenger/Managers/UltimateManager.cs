...
using EloBuddy; namespace SFXChallenger.Managers
{
    public class UltimateManager
    {
        ...
        public Func<AIHeroClient, float, bool, float> DamageCalculation { get; set; }
        ...
        public bool IsActive(UltimateModeType mode, AIHeroClient hero = null)
        {
            if (_menu != null)
            {
        ...
        public float GetDamage(AIHeroClient hero, UltimateModeType mode, int hits = 5)
        {
            if (DamageCalculation != null)
            {
                try
        ...
        public bool CheckSingle(UltimateModeType mode, AIHeroClient target)
        {
            try
            {
        ...
        public bool Check(UltimateModeType mode, List<AIHeroClient> hits)
        {
            try
            {
