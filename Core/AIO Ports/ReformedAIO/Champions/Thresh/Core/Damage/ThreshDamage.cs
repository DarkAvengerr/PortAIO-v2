...
namespace ReformedAIO.Champions.Thresh.Core.Damage
{
    using LeagueSharp;
    using LeagueSharp.Common;
    ...
    internal sealed class ThreshDamage : ChildBase
    {
        ...
        public ThreshDamage(QSpell qSpell, ESpell eSpell, RSpell rSpell)
        {
            this.qSpell = qSpell;
            this.eSpell = eSpell;
            this.rSpell = rSpell;
