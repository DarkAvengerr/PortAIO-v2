...
namespace ReformedAIO.Champions.Lux.Misc
{
    using LeagueSharp;
    using LeagueSharp.Common;
    ...
    internal sealed class LuxAntiGapcloser : OrbwalkingChild
    {
        public override string Name { get; set; } = "Anti-Gapcloser";

        private readonly QSpell spell;

        public LuxAntiGapcloser(QSpell spell)
        {
            this.spell = spell;
        }
        ...
        {
            if (!CheckGuardians() || gapcloser.Sender == null || !spell.Collision(gapcloser.Sender))
            {
                return;
            }
