...
namespace ReformedAIO.Champions.Gragas.Core.Damage
{
    using LeagueSharp;
    using LeagueSharp.Common;
    ...
    internal sealed class GragasDamage : ChildBase
    {
        ...
        public GragasDamage(QSpell qSpell, WSpell wSpell, ESpell eSpell, RSpell rSpell)
        {
            this.qSpell = qSpell;
            this.wSpell = wSpell;
            this.eSpell = eSpell;
