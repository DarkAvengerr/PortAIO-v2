    ...
    internal sealed class EDrawing : ChildBase
    {
        ...
        public void OnEndScene(EventArgs args)
        {
            ...
            Render.Circle.DrawCircle(ObjectManager.Player.Position,
                                     ...
                                     ? Color.Cyan
                                     : Color.DarkSlateGray,
                                     Menu.Item("Xerath.Draw.E.Width").GetValue<Slider>().Value,
                                     Menu.Item("Xerath.Draw.E.Z").GetValue<bool>());
        }
        ...
        protected override void OnLoad(object sender, FeatureBaseEventArgs eventArgs)
        {
            ...
            Menu.AddItem(new MenuItem("Xerath.Draw.E.Z", "Draw Z").SetValue(false));

            Menu.AddItem(new MenuItem("Xerath.Draw.E.Width", "Thickness").SetValue(new Slider(3, 1, 5)));
        }
    }
}
