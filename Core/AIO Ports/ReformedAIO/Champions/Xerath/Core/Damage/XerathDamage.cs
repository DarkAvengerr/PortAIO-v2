...
namespace ReformedAIO.Champions.Xerath.Core.Damage
{
    using LeagueSharp;
    using LeagueSharp.Common;
    ...
    class XerathDamage : ChildBase
    {
        ...
        public XerathDamage(QSpell qSpell, WSpell wSpell, ESpell eSpell, RSpell rSpell)
        {
            this.qSpell = qSpell;
            this.wSpell = wSpell;
            this.eSpell = eSpell;
