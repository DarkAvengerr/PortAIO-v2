...
namespace ReformedAIO.Champions.Brand.OrbwalkingMode.Jungle
{
    ...
    internal sealed class EJungle : OrbwalkingChild
    {
        ...
        private void OnUpdate(EventArgs args)
        {
            if (!CheckGuardians()
                || Mob == null
                || Menu.Item("Brand.Jungle.E.Mana").GetValue<Slider>().Value > ObjectManager.Player.ManaPercent)
            {
                return;
            }
        ...
        protected override void OnLoad(object sender, FeatureBaseEventArgs eventArgs)
        {
            ...
            Menu.AddItem(new MenuItem("Brand.Jungle.E.Mana", "Min Mana %").SetValue(new Slider(0, 0, 100)));
        }
    }
}
