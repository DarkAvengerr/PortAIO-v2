...
namespace ReformedAIO.Champions.Brand.OrbwalkingMode.Jungle
{
    ...
    internal sealed class QJungle : OrbwalkingChild
    {
        ...
        private void OnUpdate(EventArgs args)
        {
            if (!CheckGuardians()
                || Mob == null
                || Menu.Item("Brand.Jungle.Q.Mana").GetValue<Slider>().Value > ObjectManager.Player.ManaPercent)
            {
                return;
            }
        ...
        protected override void OnLoad(object sender, FeatureBaseEventArgs eventArgs)
        {
            ...
            Menu.AddItem(new MenuItem("Brand.Jungle.Q.Mana", "Min Mana %").SetValue(new Slider(0, 0, 100)));
        }
    }
}
