...
namespace ReformedAIO.Champions.Brand.Core.Damage
{
    using LeagueSharp;
    using LeagueSharp.Common;
    ...
    class BrandDamage : ChildBase
    {
        ...
        public BrandDamage(QSpell qSpell, WSpell wSpell, ESpell eSpell, RSpell rSpell)
        {
            this.qSpell = qSpell;
            this.wSpell = wSpell;
            this.eSpell = eSpell;
