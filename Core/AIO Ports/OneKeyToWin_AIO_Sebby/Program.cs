...
namespace OneKeyToWin_AIO_Sebby
{
    class Program
    {
        ...
        private static string OktNews = "ORBWALKER BETA, Notifications options, new incoming damage calculation";
        ...
        public static void GameOnOnGameLoad()
        {
            ...
            Config.AddItem(new MenuItem("AIOmode", "AIO mode", true).SetValue(new StringList(new[] { "Only Champion" }, 0))).ValueChanged += Program_ValueChanged;
            ...
            */
            ...
            if (AioModeSet != AioMode.UtilityOnly)
            {
                ...
                Config.SubMenu("Prediction MODE").AddItem(new MenuItem("Qpred", "Q Prediction MODE", true).SetValue(new StringList(new[] { "Common prediction", "OKTW© PREDICTION", "SPediction press F5 if not loaded", "SDK" }, 0)));
                ...
                Config.SubMenu("Prediction MODE").AddItem(new MenuItem("Wpred", "W Prediction MODE", true).SetValue(new StringList(new[] { "Common prediction", "OKTW© PREDICTION", "SPediction press F5 if not loaded", "SDK" }, 0)));
                ...
                Config.SubMenu("Prediction MODE").AddItem(new MenuItem("Epred", "E Prediction MODE", true).SetValue(new StringList(new[] { "Common prediction", "OKTW© PREDICTION", "SPediction press F5 if not loaded", "SDK" }, 0)));
                ...
                Config.SubMenu("Prediction MODE").AddItem(new MenuItem("Rpred", "R Prediction MODE", true).SetValue(new StringList(new[] { "Common prediction", "OKTW© PREDICTION", "SPediction press F5 if not loaded", "SDK" }, 0)));
