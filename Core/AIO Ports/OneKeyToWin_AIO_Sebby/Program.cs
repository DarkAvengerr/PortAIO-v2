    ...
    class Program
    {
        ...
        public static void GameOnOnGameLoad()
        {
            ...
            if (AioModeSet != AioMode.UtilityOnly)
            {
                ...
                Config.SubMenu("Prediction MODE").AddItem(new MenuItem("Qpred", "Q Prediction MODE", true).SetValue(new StringList(new[] { "EB prediction", "OKTW© PREDICTION", "SPediction press F5 if not loaded", "SDK", "L# Prediction" }, 1)));
                ...
                Config.SubMenu("Prediction MODE").AddItem(new MenuItem("Wpred", "W Prediction MODE", true).SetValue(new StringList(new[] { "EB prediction", "OKTW© PREDICTION", "SPediction press F5 if not loaded", "SDK", "L# Prediction" }, 1)));
                ...
                Config.SubMenu("Prediction MODE").AddItem(new MenuItem("Epred", "E Prediction MODE", true).SetValue(new StringList(new[] { "EB prediction", "OKTW© PREDICTION", "SPediction press F5 if not loaded", "SDK", "L# Prediction" }, 1)));
                ...
                Config.SubMenu("Prediction MODE").AddItem(new MenuItem("Rpred", "R Prediction MODE", true).SetValue(new StringList(new[] { "EB prediction", "OKTW© PREDICTION", "SPediction press F5 if not loaded", "SDK", "L# Prediction" }, 1)));
