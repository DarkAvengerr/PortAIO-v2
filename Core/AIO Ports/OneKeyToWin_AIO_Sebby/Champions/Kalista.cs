 ...
 namespace OneKeyToWin_AIO_Sebby.Champions
{
    class Kalista : Base
    {
        ...
        private void Game_OnUpdate(EventArgs args)
        {
            ...
            if (R.IsReady() && AllyR != null && Config.Item("balista", true).GetValue<bool>() &&  AllyR.IsHPBarRendered && AllyR.Distance(Player.Position) < R.Range && AllyR.ChampionName == "Blitzcrank" && Player.Distance(AllyR.Position) > Config.Item("rangeBalista", true).GetValue<Slider>().Value)
            {
        ...
        private void SurvivalLogic()
        {
            ...
            if (R.IsReady())
            {
                if (R.IsReady() && AllyR != null && AllyR.IsHPBarRendered && AllyR.HealthPercent < 50 && AllyR.Distance(Player.Position) < R.Range)
                {
        ...
        private void LogicR()
        {
            ...
            else if (AllyR.IsHPBarRendered && AllyR.Distance(Player.Position) < R.Range)
            {
