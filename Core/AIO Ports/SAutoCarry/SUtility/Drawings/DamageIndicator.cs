...
namespace SUtility.Drawings
{
    ...
    {
        public delegate float dCalculateDamage(AIHeroClient target);
        ...
        /// <summary>
        /// Gest or sets damage indicator enabled value
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets Fill HP Bar value
        /// </summary>
