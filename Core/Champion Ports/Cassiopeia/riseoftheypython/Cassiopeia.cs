...
using EloBuddy; 
 using LeagueSharp.Common; 
 namespace riseofthepython.Champions
{
	public class Cassiopeia : Assemblyhelper
	{
		...
		static void Cassiopeia_OnGameLoad()
		{
			...
			Chat.Print("<font color='#15C3AC'>Riseofthepython:</font> <font color='#FFFFFF'>" +player.ChampionName + " Loaded! </font>");
