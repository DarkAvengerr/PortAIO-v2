...
namespace RoachKayle
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad()
        {
            ...
            Variable.Dfg = LeagueSharp.Common.Utility.Map.GetMap().Type == LeagueSharp.Common.Utility.Map.MapType.TwistedTreeline
            ...
            Chat.Print("<font color=\"#00BFFF\">Kayle# -</font> <font color=\"#FFFFFF\">Loaded</font>");
