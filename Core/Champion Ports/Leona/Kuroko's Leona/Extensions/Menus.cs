 ...
 namespace Kuroko_s_Leona.Extensions
{
    internal static class Menus
    {
        ...
        {
            Config = new Menu("Kuroko's Leona", "Kuroko's Leona", true);
            {
                ...
                var clearmenu = new Menu("Wave Settings", "Wave Settings");
                {
                    ...
                    clearmenu.AddItem(new MenuItem("w.min.count", "[W] Min. Minion Count").SetValue(new Slider(3, 1, 5)));
                ...
                var junglemenu = new Menu("Jungle Clear Settings", "Jungle Clear Settings");
                {
                    ...
                    junglemenu.AddItem(new MenuItem("w.jungle", "Use [Q]").SetValue(true));
