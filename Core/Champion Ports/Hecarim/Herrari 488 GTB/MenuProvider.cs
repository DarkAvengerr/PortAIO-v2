 ...
 namespace Herrari_488_GTB
{
    ...
    class MenuProvider
    {
        ...
        internal static void initialize()
        {
            ...
            {
                MenuInstance = new Menu("Herrari 488 GTB", "Herrari_488_GTBCommon", true);
            ...
            {
                MenuInstance = new Menu("Herrari 488 GTB: " + "(X)", "Herrari_488_GTBCommon", true);
            ...
            Console.WriteLine("Herrari 488 GTB: MenuProvider Initialized.");
        }
