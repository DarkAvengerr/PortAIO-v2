    ...
    internal class Configs
    {
        ...
        public static void Initialize()
        {
            try
            {
                ...
                comboR.AddItem(new MenuItem("useRmulti", "Use R if multiple targets").SetValue(true));
                comboR.AddItem(new MenuItem("multiRtargets", "If X targets").SetValue(new Slider(3, 1, 5)));
                ...
                lastHitMenu.AddItem(new MenuItem("useWlh", "Use W if no AA or Q available").SetValue(true));
