    ...
    public class Program
    {
        ...
        private static void OnSpellCast(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            ...
            if (args.Target is AIHeroClient)
            {
                ...
                {
                    LeagueSharp.Common.Utility.DelayAction.Add(Humanizer, () => OnSpellCastDelayed(args));
                }
        ...
        private static void OnSpellCastLC(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            ...
            if (args.Target is Obj_AI_Minion)
            {
                if (Orbwalker.ActiveMode == Orbwalking.OrbwalkingMode.LaneClear && args.Target.IsValid)
                {
                    LeagueSharp.Common.Utility.DelayAction.Add(Humanizer, () => OnSpellCastDelayedLC(args));
                }
            }
        }
        ...
        private static void OnSpellCastDelayedLC(GameObjectProcessSpellCastEventArgs args)
        {
            AAPassive = false;
        ...
        private static void OnSpellCastDelayed(GameObjectProcessSpellCastEventArgs args)
        {
            AAPassive = false;
            if (args.Target is AIHeroClient)
            {
