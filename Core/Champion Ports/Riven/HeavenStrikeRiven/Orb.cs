        ...
        private static void Obj_AI_Base_OnSpellCast(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            ...
            try
            {
                    ...
                    (args.Target is Obj_AI_Base || args.Target is Obj_BarracksDampener || args.Target is Obj_HQ))
                {
                    ...
                    //_missileLaunched = true;
                    LeagueSharp.Common.Utility.DelayAction.Add(40 + windup > Game.Ping ? 40 + windup - Game.Ping : 0, () => FireAfterAttack(sender, _lastTarget));
                    LeagueSharp.Common.Utility.DelayAction.Add(40 + windup> Game.Ping ? 40 + windup - Game.Ping : 0, () => StopMove = false);
