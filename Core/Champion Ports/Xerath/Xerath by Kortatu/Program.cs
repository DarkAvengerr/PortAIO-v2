...
namespace Xerath
{
    internal class Program
    {
        ...
        public static void Game_OnGameLoad()
        {
            ...
            //LeagueSharp.Common.Utility.HpBar//DamageIndicator.DamageToUnit += hero => (float)Player.GetSpellDamage(hero, SpellSlot.R) * new int[] { 0, 3, 4, 5 }[Player.GetSpell(SpellSlot.R).Level];
        ...
        private static void Drawing_OnEndScene(EventArgs args)
        {
            ...
            if (menuItem.Active)
                LeagueSharp.Common.Utility.DrawCircle(Player.Position, R.Range, menuItem.Color, 1, 23, true);
        }
