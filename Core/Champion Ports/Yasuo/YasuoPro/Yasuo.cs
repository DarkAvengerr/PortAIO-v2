...
namespace YasuoPro
{
    ...
    internal class Yasuo : Helper
    {
        ...
        public void OnLoad()
        {
            ...
            Chat.Print("<font color='#12FA54'>::::Latest Update: Updated Evade spells & Added very beta Beyblade mode (Enable in Combo) - need feedback. also some bugfixes!</font>");
