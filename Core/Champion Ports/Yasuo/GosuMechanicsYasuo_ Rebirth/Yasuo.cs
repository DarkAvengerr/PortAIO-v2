        ...
        public static void WallDash()
        {
            if (Program.myHero.Distance(spotA) <= 600)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.IsValidTarget(Program.myHero.AttackRange)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotA.To3D()) && jungleMobs.BaseSkinName == "SRU_Blue" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.IsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.Distance(spotB) <= 600)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.IsValidTarget(Program.myHero.AttackRange)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotB.To3D()) && jungleMobs.BaseSkinName != "SRU_Red" && jungleMobs.BaseSkinName != "SRU_RedMini4.1.3" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.IsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.Distance(spotD) <= 600)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.IsValidTarget(100)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotD.To3D()) && jungleMobs.BaseSkinName != "SRU_Razorbreak" && jungleMobs.BaseSkinName != "SRU_RazorbreakMini3.1.2" && jungleMobs.BaseSkinName != "SRU_RazorbreakMini3.1.4" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.IsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.Distance(spotE) <= 600)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.IsValidTarget(Program.E.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotE.To3D()) && jungleMobs.BaseSkinName == "SRU_KrugMini" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.IsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.Distance(spotF) <= 400)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.IsValidTarget(Program.E.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotF.To3D()) && jungleMobs.BaseSkinName != "SRU_Blue" && jungleMobs.BaseSkinName != "SRU_BlueMini1.1.2" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.IsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.Distance(spotG) <= 600)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.IsValidTarget(Program.myHero.AttackRange)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotG.To3D()) && jungleMobs.BaseSkinName != "SRU_Murkwolf" && jungleMobs.BaseSkinName != "SRU_MurkwolfMini2.1.3" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.IsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.Distance(spotI) <= 120)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.IsValidTarget(100)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotI.To3D()) && jungleMobs.BaseSkinName != "SRU_Murkwolf" && jungleMobs.BaseSkinName != "SRU_MurkwolfMini8.1.3" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.IsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.Distance(spotJ) <= 120)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.IsValidTarget(Program.E.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotJ.To3D()) && jungleMobs.BaseSkinName != "SRU_Murkwolf" && jungleMobs.BaseSkinName != "SRU_MurkwolfMini8.1.2" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.IsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.Distance(spotL) <= 600)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.IsValidTarget(Program.E.Range)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotL.To3D()) && jungleMobs.BaseSkinName == "SRU_KrugMini" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.IsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.Distance(spotM) <= 200)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.IsValidTarget(Program.myHero.AttackRange)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotM.To3D()) && jungleMobs.BaseSkinName != "SRU_Red" && jungleMobs.BaseSkinName != "SRU_RedMini10.1.3" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.IsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.Distance(spotN) <= 600)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.IsValidTarget(100)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotN.To3D()) && jungleMobs.BaseSkinName != "SRU_RazorbreakMini9.1.2" && jungleMobs.BaseSkinName != "SRU_RazorbreakMini9.1.4" && jungleMobs.BaseSkinName != "SRU_Razorbreak" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
            ...
            if (Program.myHero.Distance(spotO) <= 200)
            {
                ...
                foreach (var jungleMobs in jminions.Where(x => x.IsValidTarget(Program.myHero.AttackRange)))
                {
                    ...
                    if (Program.myHero.ServerPosition.Equals(spotO.To3D()) && jungleMobs.BaseSkinName != "SRU_Red" && jungleMobs.BaseSkinName != "SRU_RedMini10.1.2" && jungleMobs.IsVisible && Program.E.IsReady() && jungleMobs != null && jungleMobs.IsValidTarget(Program.E.Range) && Program.CanCastE(jungleMobs))
                    {
                        Program.E.CastOnUnit(jungleMobs);
                    }
                }
