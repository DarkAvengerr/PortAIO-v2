...
namespace EasyEzreal
{
    class EazyEzreal : EasyLib1.Champion
    {
        ...
        {
            if (Menu.Item("Auto_q").GetValue<bool>() && !(Menu.Item("Auto_manaE").GetValue<bool>() && Player.Spellbook.GetSpell(SpellSlot.E).Level >= 1 && Player.Mana < Player.Spellbook.GetSpell(SpellSlot.E).SData.Mana + Player.Spellbook.GetSpell(SpellSlot.Q).SData.Mana)) Spells.CastSkillshot("Q", TargetSelector.DamageType.Physical);
            if (Menu.Item("Auto_w").GetValue<bool>() && !(Menu.Item("Auto_manaE").GetValue<bool>() && Player.Spellbook.GetSpell(SpellSlot.E).Level >= 1 && Player.Mana < Player.Spellbook.GetSpell(SpellSlot.E).SData.Mana + Player.Spellbook.GetSpell(SpellSlot.W).SData.Mana)) Spells.CastSkillshot("W", TargetSelector.DamageType.Magical);
        }
        ...
        private void CastR()
        {
            ...
            AIHeroClient target = TargetSelector.GetTarget(Menu.Item("Auto_maxrange").GetValue<Slider>().Value, TargetSelector.DamageType.Magical);
        ...
        private float UltimateDamage(AIHeroClient hero)
        {
            Spell R = Spells.get("R");
