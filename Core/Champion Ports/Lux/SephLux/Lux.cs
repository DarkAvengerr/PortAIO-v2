 ...
 namespace SephLux
{
    ...
    internal static class Lux
    {
            ...
            if (SpellSlot.R.IsReady() && LuxUtils.Active("Auto.R"))
            {
                ...
                foreach (var h in targets)
                {
                    ...
                    //List<Obj_AI_Base> collobjs =
                       // pred.CollisionObjects.FindAll(x => x.Type == GameObjectType.AIHeroClient && x.IsEnemy);
        ...
        private static PredictionInput WInput(AIHeroClient target)
        {
        ...
        static void Killsteal()
        {
            ...
            if (SpellSlot.R.IsReady() && LuxUtils.Active("Killsteal.UseR"))
            {
                    ...
                    List<AIHeroClient> targetss = new List<AIHeroClient>();
                ...
                if (targ != null)
                {
                    ...
                    else if (pred.AoeTargetsHitCount >= 3 || pred.CollisionObjects.Count(x => x.Type == GameObjectType.AIHeroClient) >= 2)
                    {
                        Spells[SpellSlot.R].Cast(pred.CastPosition);
                    }
                }
        ...
        public static bool IsKillableFromPoint(this AIHeroClient target, Vector3 Point)
        {
        ...
        private static void OnDraw(EventArgs args)
        {
            ...
            {
                LeagueSharp.Common.Utility.DrawCircle(Player.Position, Spells[SpellSlot.R].Range, System.Drawing.Color.Aqua, 1, 23, true);
            }
        }
