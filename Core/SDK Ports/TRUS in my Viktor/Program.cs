    ...
    public class Program
    {
        ...
        private static bool AttacksEnabled
        {
            get
            {
                ...
                {
                    return ((!Q.IsReady() || player.Mana < Q.Instance.SData.Mana) && (!E.IsReady() || player.Mana < E.Instance.SData.Mana) && (!ComboMenu["qAuto"].GetValue<MenuBool>() || player.HasBuff("viktorpowertransferreturn")));
                }
        ...
        private static void OnHarass()
        {
            ...
            if (useE)
            {
                ...
                AIHeroClient target = Variables.TargetSelector.GetTarget(harassrange, DamageType.Magical);
                if (target != null)
                    PredictCastE(target);
            }
        }
