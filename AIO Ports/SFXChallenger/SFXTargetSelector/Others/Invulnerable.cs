...
using EloBuddy; namespace SFXChallenger.SFXTargetSelector.Others
{
    public class Invulnerable
    {
        ...
        public static bool Check(AIHeroClient target,
            float damage,
        ...
        private static bool CheckFunction(Item invulnerable, AIHeroClient target, DamageType damageType)
        {
            try
            {
