...
using EloBuddy; namespace SFXChallenger.Managers
{
    ...
    public static class SummonerManager
    {
        ...
        public static bool Exists(this SummonerSpell spell, AIHeroClient sender = null)
        {
            return spell.GetSlot(sender ?? ObjectManager.Player) != SpellSlot.Unknown;
        }

        public static SpellDataInst GetSpell(this SummonerSpell spell, AIHeroClient sender = null)
        {
        ...
        public static void Cast(this SummonerSpell spell, AIHeroClient target, AIHeroClient sender = null)
        {
            if (sender == null)
            {
        ...
        public static void Cast(this SummonerSpell spell, Vector3 position, AIHeroClient sender = null)
        {
            if (sender == null)
            {
                sender = ObjectManager.Player;
        ...
        public static float CalculateComboDamage(AIHeroClient target, bool rangeCheck = true)
        {
        ...
        public static bool HasSmite(AIHeroClient hero)
        {
            return Smite.Exists(hero) || BlueSmite.Exists(hero) || RedSmite.Exists(hero);
        }

        public static bool IsSmiteReady(AIHeroClient hero)
        {
            return Smite.IsReady(hero) || BlueSmite.IsReady(hero) || RedSmite.IsReady(hero);
        }

        public static SpellDataInst GetSmiteSpell(AIHeroClient hero)
        {
        ...
        public static void UseComboSummoners(AIHeroClient target)
        {
            if (_menu == null || target == null || !_menu.Item(_menu.Name + ".enabled").GetValue<bool>())
            {
                return;
