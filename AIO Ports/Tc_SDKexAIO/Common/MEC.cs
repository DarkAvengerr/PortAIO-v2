 ...
 namespace Tc_SDKexAIO.Common
{
    ...
    {
        public static RectangleF _MinMaxBox;
        public static Vector2[] _MinMaxCorners;
        public static Vector2[] _NonCulledPoints;
            ...
            ref Vector2 lr)
        {
            ...
            _MinMaxCorners = new[] { ul, ur, lr, ll }; // For debugging.
        }
        ...
        private static List<Vector2> HullCull(List<Vector2> points)
        {
            ...
            _NonCulledPoints = new Vector2[results.Count]; // For debugging.
