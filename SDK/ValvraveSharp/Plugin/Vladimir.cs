 ...
 namespace Valvrave_Sharp.Plugin
{
    ...
    internal class Vladimir : Program
    {
        ...
        private static List<Tuple<AIHeroClient, Vector3>> GetETarget
            =>
                Variables.TargetSelector.GetTargets(E.Range + 20, E.DamageType)
                    .Select(i => new Tuple<AIHeroClient, Vector3>(i, E.GetPredPosition(i)))
            ...
            if (MainMenu["Combo"]["R"] && R.IsReady())
            {
                ...
                if (targets.Count > 0)
                {
                    ...
                    foreach (var target in targets)
                    {
                        ...
                        if ((hits.Count > 1
                             && (hits.Any(i => i.Health + i.MagicShield <= R.GetDamage(i))
        ...
        private static void ERelease()
        {
            ...
            Player.Spellbook.UpdateChargeableSpell(E.Slot, Player.Position, true, false);
        ...
        private static void KillSteal()
        {
            ...
            if (MainMenu["KillSteal"]["E"] && CanCastE
                && GetETarget.Any(i => i.Item1.Health + i.Item1.MagicShield <= GetEDmg(i.Item1)))
            {
                if (E.IsReady())
                {
                    ECharge(true);
