 ...
 namespace Flowers_Series.Common.Evade
{
    ...
    public class Skillshot
    {
        ...
        public bool IsGlobal
        {
            get
            {
                return SpellData.RawRange == 20000;
            }
        }
        ...
        {
            return Config.Menu["Skillshots"][this.SpellData.MenuItemName]["DangerLevel" + this.SpellData.MenuItemName].GetValue<MenuSlider>().Value;
        }

        public bool IsDanger()
        {
            return Config.Menu["Skillshots"][this.SpellData.MenuItemName]["IsDangerous" + this.SpellData.MenuItemName];
        }

        public bool DrawSpell()
        {
            return Config.Menu["Skillshots"][this.SpellData.MenuItemName]["Draw" + this.SpellData.MenuItemName];
        }

        public bool IsEnable()
        {
            return Config.Menu["Skillshots"][this.SpellData.MenuItemName]["Enabled" + this.SpellData.MenuItemName];
        }
