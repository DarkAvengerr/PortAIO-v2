 ...
 namespace Orianna_by_trelli
{
    internal class BallManager
    {
        ...
        static BallManager()
        {
            ...
            AIHeroClient.OnProcessSpellCast += Obj_AI_Base_OnProcessSpellCast;
        }
        ...
        private static void Game_OnGameUpdate(EventArgs args)
        {
            ...
            foreach (var ally in ObjectManager.Get<AIHeroClient>().Where(ally => ally.IsAlly && !ally.IsDead && ally.HasBuff("orianaghost", true)))
            {
        ...
        private static void Obj_AI_Base_OnProcessSpellCast(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            ...
            {
                IsBallMoving = true;
                LeagueSharp.Common.Utility.DelayAction.Add((int)Math.Max(1, 1000 * (args.End.Distance(CurrentBallPosition) - Game.Ping - 0.1) / QSpeed), () =>
                {
