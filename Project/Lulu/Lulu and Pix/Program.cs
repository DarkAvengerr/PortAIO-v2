 ...
 namespace Lulu_and_Pix
{
    ...
    public class Program
    {
        ...
        private static void DoCombo()
        {
            ...
            if (target == null && useEq && Player.Mana > Q.Instance.SData.Mana + E.Instance.SData.Mana && Q.IsReady() && E.IsReady())
            {
        ...
        private static void DoHarass(bool toggle)
        {
            ...
            if (target == null && useEq && Player.Mana > Q.Instance.SData.Mana + E.Instance.SData.Mana)
            {
                var targetEq = TargetSelector.GetTarget(Q.Range + E.Range, TargetSelector.DamageType.Magical);
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Chat.Print("<font color=\"#7CFC00\"><b>Lulu and Pix:</b></font> by ChewyMoon & Shiver loaded");
