    ...
    public static class PRADAHijacker
    {
        ...
        public static void AttemptHijack()
        {
            LeagueSharp.Common.Utility.DelayAction.Add(3000, () =>
            {
                ...
                {
                    Chat.Print("<font color='#f4ff1c'><b>[PRADA Vayne]</b></font> VHR Detected! Attempting to load PRADA Plugin!");
                    LoadVHRPlugin();
                }
            });
        }
        ...
        public static void LoadVHRPlugin()
        {
            ...
            Chat.Print("<font color='#f4ff1c'><b>[PRADA Vayne]</b></font> VHR assembly succesfully hijacked! Enjoy!");
