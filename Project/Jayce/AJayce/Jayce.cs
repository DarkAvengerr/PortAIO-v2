 ...
 namespace AJayce
{
    internal class Jayce : Helper
    {
        ...
        public static void OnLoad(EventArgs args)
        {
            ...
            Obj_AI_Base.OnSpellCast += OnSpellCastRange;
        ...
        private static void OnSpellCastMelee(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            if (!sender.IsMe) return;
        ...
        private static void OnSpellCastRange(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            if (!sender.IsMe) return;
