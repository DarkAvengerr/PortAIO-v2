...
namespace Xerath___The_Magus_Ascendant
{
    class Program
    {
        ...
        {
            foreach (AIHeroClient hero in ObjectManager.Get<AIHeroClient>().Where(unit => unit.IsValidTarget(W.Range)))
            {
        ...
        {
            foreach (AIHeroClient hero in ObjectManager.Get<AIHeroClient>().Where(unit => unit.IsValidTarget(E.Range)))
            {
        ...
        {
            foreach (AIHeroClient hero in ObjectManager.Get<AIHeroClient>().Where(unit => unit.IsValidTarget(R.Range)))
            {
