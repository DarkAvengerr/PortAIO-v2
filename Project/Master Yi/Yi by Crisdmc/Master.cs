...
using EloBuddy; 
 using LeagueSharp.Common; 
 namespace crisMasterYi
{
    class Master
    {
        private AIHeroClient _player = ObjectManager.Player;
        ...
        private void useQ(AIHeroClient target, bool packet)
        {
        ...
        private void useE(AIHeroClient target, bool usePacket)
        {
        ...
        private void useR(AIHeroClient target, bool usePacket)
        {
        ...
        private AIHeroClient obtainTarget(bool useQ)
        {
