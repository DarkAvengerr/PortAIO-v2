    ...
    internal class Program
    {
        ...
        private static void Game_OnUpdate(EventArgs args)
        {
            ...
            if (Config.Item("fleekey").GetValue<KeyBind>().Active)
            {
                ...
                if (E.IsReady())
                {
                    LeagueSharp.Common.Utility.DelayAction.Add(300, () => E.Cast(Game.CursorPos.Extend(Player.Position, 5000)));
                }
            }
        ...
        private static void Combo()
        {
                ...
                && !target.IsZombie)
            {
                ...
                if (qSpell
                    ...
                    && Player.Mana >= Q.Instance.SData.Mana*2f
        ...
        private static void AutoW()
        {
            ...
            if (wSpell)
            {
                foreach (AIHeroClient target in HeroManager.Enemies.Where(x => x.IsValidTarget(W.Range)))
                {
                    if (target != null)
                    {
